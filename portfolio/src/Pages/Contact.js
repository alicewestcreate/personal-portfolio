    ...
    <section id="Contact">
      <div className="formContainer">
        ...
        <div className="socials">
          <a href="https://www.linkedin.com/in/alicegwest/" target={"blank"}><i class="fa-solid fa-file fa-xl"></i></a>
          ...
          <a href="mailto:alicewestdesigns@gmail.com" target={"blank"}><i class="fa-solid fa-envelope fa-xl"></i></a>
        </div>
      </div>
    </section>
  );
